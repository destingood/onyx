...
namespace BTOptimizer
{
    ...
    internal static class Crosshair
    {
        ...
        {
            get { if (_autoSettings == null) _autoSettings = CrosshairSettings.Load(); return _autoSettings.AutoGame; }
        }
        ...
        /// <summary>
        /// Tick « viseur AUTO en jeu » : affiche le réticule à l'ENTRÉE en jeu, le retire au retour
        /// au bureau. Ne ré-affiche pas un viseur masqué à la main en pleine partie, et ne retire
        /// jamais un affichage manuel.
        /// </summary>
