...
namespace BTOptimizer
{
    ...
    internal static class DocAssistant
    {
        ...
        private static readonly string[][] Lexicon =
        {
            ...
            new[] { "5g;4g;box 5g;box 4g;box mobile;cgnat;mtu;bouygues;partage de connexion", "En 4G/5G (box mobile, partage de connexion), trois choses plombent le jeu : la MTU rabotée par le transport mobile (paquets fragmentés → micro-freezes), le CGNAT (adresse partagée → NAT strict), et le bufferbloat (ping qui explose dès que quelqu'un télécharge). Le panneau Connexion 4G/5G mesure les trois sur TON lien et corrige la MTU en un clic, réversible.", "Connexion 4G/5G" },
