...
[assembly: AssemblyVersion("14.25.0.0")]
[assembly: AssemblyFileVersion("14.25.0.0")]
    ...
    internal static class TestHarness
    {
        public static void Run()
        {
            ...
            try
            {
                ...
                using (var f = new PerfOverlayForm(delegate(string m, int l) { })) { f.CreateControl(); }
                try { PerfOverlay.Hide(); } catch { } // nettoyage si l'overlay a été montré (réglage activé)
                Console.WriteLine("  UI PerfOverlayForm : construite OK.");
